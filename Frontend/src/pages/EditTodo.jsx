...
const EditTodo = () => {
    ...
    const { todos, todoInput, setTodoInput, handleInputChange, handleEditTodo } = useContext(TodoContext)
    ...
    return (
        <div className="relative w-full max-w-md px-2 md:px-0">
            ...
            <div className="flex items-center justify-center bg-[#ED985F] rounded-lg w-full  h-[600px]  p-2" >
                ...
                {/* Todo Input Section */}
                <form className=" flex flex-col gap-4 w-[90%] p-2 bg-[#F7B980] rounded-lg " onSubmit={handleUpdateTodo} >
